...
def make_tokenizer(tokenizer_type, corpus, model_path=None, vocab_size=None, model_type='bpe', pad_token=0, character_coverage=1.0, command_tokens=None, type_tokens=None, **kwargs):
    ...
    elif tokenizer_class is RubertaBPETokenizer:
        return RubertaBPETokenizer(model_path=model_path, **kwargs)
...
class RubertaBPETokenizer(Tokenizer):
    def __init__(self, model_path=None, **kwargs):
        self.text_tokenizer = RubertaTokenizer(vocab_file=model_path)
